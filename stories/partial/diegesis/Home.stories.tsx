...
const SectionActionButtonTemplate: ComponentStory<typeof SectionActionButton> = args => (
...
const StatWithDescriptionTemplate: ComponentStory<typeof StatWithDescription> = args => (
